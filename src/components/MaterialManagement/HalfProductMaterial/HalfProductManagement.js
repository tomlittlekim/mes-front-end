...
import {
  DELETE_MUTATION, HALF_MATERIAL_QUERY,
  MATERIAL_MUTATION
      ...
      <Box mt={2} p={2} sx={{ 
        ...
        <Stack spacing={1}>
          <Typography variant="body2" color={getTextColor()}>
            • 반제품관리에서는 생산 공정 중 발생하는 중간 반제품의 정보를 등록, 수정, 삭제할 수 있습니다.
          </Typography>
          <Typography variant="body2" color={getTextColor()}>
            • 반제품 코드, 반제품명, 규격, 단위 등의 기본 정보와 함께 보관 창고를 지정할 수 있습니다.
          </Typography>
          <Typography variant="body2" color={getTextColor()}>
